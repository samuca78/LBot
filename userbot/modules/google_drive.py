...
CMD_HELP.update(
    {
        "gdrive": ">`.gdauth`"
        "\n**Uso:** gerar token para habilitar todos os serviços cmd google drive."
        "\nIsso só precisa ser executado uma vez na vida."
        "\n\n>`.gdreset`"
        "\n**Uso:** redefina seu token se algo de errado acontecer ou mude o acc do drive."
        "\n\n>`.gd`"
        "\n**Uso:** Faça upload do arquivo de local ou uri/url/drivelink para o Google Drive."
        "\npara drivelink, é só carregar se você quiser."
        "\n\n>`.gdabort`"
        "\n**Uso:** Aborta o processo de upload ou download."
        "\n\n>`.gdlist`"
        "\n**Uso:** Obtém lista de pastas e arquivos com tamanho padrão 50."
        "\nUse os parâmetros `-l range[1-1000]` para limite de saída."
        ...
        "em **G_DRIVE_FOLDER_ID** e se estiver vazio, o upload irá para a raíz."
        "\n\nNOTA:"
        "\npra >`.gdlist` você pode combinar os parâmetros -l e -p com ou sem nome "
        "ao mesmo tempo, deve ser `-l` parâmetro antes de usar `-p` parâmetro.\n"
        "E, por padrão, lista os mais recentes 'hora da modificação' e depois pastas."
    }
)
